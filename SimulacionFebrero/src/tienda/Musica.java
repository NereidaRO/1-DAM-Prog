...
public class Musica extends Producto{
    ...
    String genero;
    //Constructores
    public Musica(String genero, int idProducto, String nombre, double precioUni, int cantStock) {
        super(idProducto, nombre, precioUni, cantStock);
        this.genero = genero;
    }
    public Musica(int idProducto) {
        super(idProducto);
    }
    //Getters y Setters
    ...
    public String toString() {
        System.out.println("ARTÍCULO DE MÚSICA:\n"
                + super.toString()
                + "Género: " + this.genero);
